  ...
  <div className="container text-md-left">
    <div className="row text-md-left">
      ...
      <div className="col-md-4 col-lg-4 col-xl-3 mx-auto mt-3">
        <h5 className="text-uppercase mb-4 font-weight-bold text-warning">ResortEscape</h5>
        <p>
          Discover and book luxury resorts worldwide. Relax, recharge, and escape the ordinary with our hand-picked destinations.
        </p>
      </div>
      ...
      <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
        ...
        <p><a href="#" className="text-white text-decoration-none">Destinations</a></p>
      ...
      <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p><i className="bi bi-geo-alt-fill me-2"></i>123 Beachside Ave, Maldives</p>
        <p><i className="bi bi-envelope-fill me-2"></i>support@resortescape.com</p>
      ...
      <div className="col-md-2 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <a href="#" className="text-white me-4"><i className="bi bi-facebook fs-4"></i></a>
        <a href="#" className="text-white me-4"><i className="bi bi-instagram fs-4"></i></a>
        <a href="#" className="text-white me-4"><i className="bi bi-twitter-x fs-4"></i></a>
